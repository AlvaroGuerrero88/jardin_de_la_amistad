...
export function Footer() {
    return (
        <footer className="bg-[#1B4965] text-white py-12 relative z-[100] border-none !border-0 before:!content-none after:!content-none mt-[-1px] overflow-hidden" style={{ backgroundImage: 'none', borderTop: 'none' }}>
